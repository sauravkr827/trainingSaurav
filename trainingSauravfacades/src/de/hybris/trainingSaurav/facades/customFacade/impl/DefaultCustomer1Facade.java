...
public class DefaultCustomer1Facade implements Customer1Facade
{
    ...
    Converter<CustomerModel, CustomerData> customerDataConverter;
    ...
    @Override
    public List<CustomerData> getListOfCustomerFromExisting() {
        List<CustomerModel> customerModels=defaultCustomer1Service.getListOfCustomerFromExisting();

        List<CustomerData> customerData=getCustomerDataConverter().convertAll(customerModels);
