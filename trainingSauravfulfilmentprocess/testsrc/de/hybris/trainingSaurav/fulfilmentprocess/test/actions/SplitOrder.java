 ...
 */
package de.hybris.trainingSaurav.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TrainingSauravFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TrainingSauravFulfilmentProcessConstants.PARENT_PROCESS);
