 ...
 */
package de.hybris.trainingSaurav.fulfilmentprocess.test.jobs;
...
import de.hybris.trainingSaurav.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TrainingSauravFulfilmentProcessConstants.ORDER_PROCESS_NAME;
