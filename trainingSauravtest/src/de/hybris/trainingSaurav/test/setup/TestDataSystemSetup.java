 ...
 */
package de.hybris.trainingSaurav.test.setup;
...
import de.hybris.trainingSaurav.test.constants.TrainingSauravTestConstants;
import de.hybris.trainingSaurav.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TrainingSauravTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/trainingSauravtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/trainingSauravtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/trainingSauravtest/import/cstickets.impex");
			...
			importImpexFile(context, "/trainingSauravtest/import/csquotes.impex");
		}
	}
}
