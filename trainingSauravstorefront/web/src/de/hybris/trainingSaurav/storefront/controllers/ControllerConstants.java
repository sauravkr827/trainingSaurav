 ...
 */
package de.hybris.trainingSaurav.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			{
				String single="pages/customManufacturer/single";
				String list="pages/customManufacturer/list";
				String pagination="pages/customManufacturer/pagination";
