 ...
 */
package de.hybris.trainingSaurav.core.constants;

/**
 * Global class for all TrainingSauravCore constants. You can add global constants for your extension into this class.
 */
public final class TrainingSauravCoreConstants extends GeneratedTrainingSauravCoreConstants
{
	public static final String EXTENSIONNAME = "trainingSauravcore";


	private TrainingSauravCoreConstants()
	{
		//empty
	}
